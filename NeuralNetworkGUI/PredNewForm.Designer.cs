namespace NeuralNetworkGUI
{
    partial class PredNewForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.Name = "PredNewForm";
			this.Text = "Predecir Nuevos";
			this.Load += new System.EventHandler(this.PredNewForm_Load);
